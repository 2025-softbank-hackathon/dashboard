      ...
      try {
        ...
        this.ws.onmessage = (event) => {
          ...
          try {
            ...
            if (payload.cloudwatch_metrics) {
              this.emit('cloudwatch_metrics', payload.cloudwatch_metrics)
            }

            if (payload.xray_service_graph) {
              this.emit('xray_service_graph', payload.xray_service_graph)
            }
